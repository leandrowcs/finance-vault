...
function viewFromHash(): NavigationView {
  return typeof window !== "undefined" && window.location.hash === "#payments" ? "payments" : "dashboard";
}
